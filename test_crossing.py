...
def main():
    ...
    # 不穿越交叉点
    strokes1, curves1, _ = test_shape(
        "Cross (no crossing)", cross, cross_junctions=False
    )
    visualize_results(
        "Cross_NoCrossing",
        cross,
    ...
    # 穿越交叉点
    strokes2, curves2, _ = test_shape(
        "Cross (with crossing)", cross, cross_junctions=True
    )
    visualize_results(
        "Cross_WithCrossing",
        cross,
    ...
    strokes3, curves3, _ = test_shape(
        "X-shape (no crossing)", x_shape, cross_junctions=False
    )
    visualize_results(
        "X_NoCrossing", x_shape, strokes3, curves3, "results_crossing/x_no_crossing.png"
    )

    strokes4, curves4, _ = test_shape(
        "X-shape (with crossing)", x_shape, cross_junctions=True
    )
    visualize_results(
        "X_WithCrossing",
        x_shape,
    ...
    strokes5, curves5, _ = test_shape(
        "T-shape (no crossing)", t_shape, cross_junctions=False
    )
    visualize_results(
        "T_NoCrossing", t_shape, strokes5, curves5, "results_crossing/t_no_crossing.png"
    )

    strokes6, curves6, _ = test_shape(
        "T-shape (with crossing)", t_shape, cross_junctions=True
    )
    visualize_results(
        "T_WithCrossing",
        t_shape,
